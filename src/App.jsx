...
const DAILY_THEMES = [
  { name: 'ぼっち', color: '#de7b8e', dim: 'rgba(222,123,142,0.10)' },  // 周日/周三 - 粉
  { name: '虹夏',   color: '#d4a03c', dim: 'rgba(212,160,60,0.10)' },   // 周一/周四 - 金
  { name: 'リョウ', color: '#6889a8', dim: 'rgba(104,137,168,0.10)' },  // 周二/周五 - 蓝
  { name: '喜多',   color: '#c9505e', dim: 'rgba(201,80,94,0.10)' },    // 周六 - 红
]
...
const DAILY_QUOTES = [
  ...
  { text: '要是能像空气吉他一样，什么都不做就能弹就好了...', who: 'ぼっち' },
  { text: '乐队就是要大家一起才有趣啊！', who: '虹夏' },
  { text: '结束乐队，是我们的全部。', who: '喜多' },
  { text: '反正我这种人，就算消失也不会有人在意的...', who: 'ぼっち' },
  { text: '音乐是不需要语言的。', who: 'リョウ' },
  { text: '只要站在舞台上，大家就都是主角。', who: '虹夏' },
  { text: '今天也是社恐的一天呢。', who: 'ぼっち' },
  { text: '贝斯才是乐队的灵魂。', who: 'リョウ' },
  { text: '第一次Live居然成功了！', who: '喜多' },
  { text: '想要被人需要，想要被人认可。', who: 'ぼっち' },
  { text: '闪闪发光的青春，大概就是这样的吧。', who: '虹夏' },
  { text: '音乐不会背叛你。', who: 'リョウ' },
  { text: '吉他英雄什么的，才不是我的目标呢...才怪。', who: 'ぼっち' },
  { text: '今天的练习，是为了明天的Live！', who: '喜多' },
  { text: '下町的空气里，都带着摇滚的味道。', who: 'リョウ' },
  { text: '就算只有一个人也好，想组乐队。', who: 'ぼっち' },
  { text: '大家在一起，就是最棒的乐队。', who: '虹夏' },
  { text: '吉他弦断了也要继续弹！', who: 'ぼっち' },
  { text: '贝斯线才是让身体动起来的关键。', who: 'リョウ' },
  { text: 'Live House的灯光，是最美的风景。', who: '喜多' },
  { text: '社恐不是病，是超能力。', who: 'ぼっち' },
  { text: 'STAR☆的光芒，照亮每一个角落！', who: '喜多' },
  { text: '明天也要努力练习吉他！...大概。', who: 'ぼっち' },
  { text: '下课铃响了就是乐队时间！', who: '虹夏' },
  { text: '衣服是用来穿的，不是用来品味的。', who: 'リョウ' },
  { text: '第一次收到LINE消息居然不是广告！', who: 'ぼっち' },
  { text: '后藤同学的吉他，真的很厉害哦。', who: '喜多' },
  { text: '青春就是不断试错的过程。', who: '虹夏' },
  { text: '贝斯手的孤独，你们不懂。', who: 'リョウ' },
]
